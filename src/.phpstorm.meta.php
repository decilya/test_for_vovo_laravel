...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Contracts\ProductRepositoryInterface' => \App\Repositories\Eloquent\ProductRepository::class,
    ...
    override(\config(), map([
            ...
            'api.rate_limit.requests_per_minute' => 'string',
            'api.rate_limit.max_attempts' => 'string',
            'api.cors.allowed_origins' => 'array',
            'api.cors.allowed_methods' => 'array',
            'api.cors.allowed_headers' => 'array',
            'api.cors.exposed_headers' => 'array',
            'api.cors.max_age' => 'string',
            'api.cors.supports_credentials' => 'boolean',
            'api.pagination.default_per_page' => 'string',
            'api.pagination.max_per_page' => 'string',
            'api.cache.enabled' => 'boolean',
            'api.cache.ttl' => 'string',
            'api.security.force_https' => 'boolean',
            'api.security.hide_server_header' => 'boolean',
            'api.security.hide_powered_by_header' => 'boolean',
            'api.logging.enabled' => 'boolean',
            'api.logging.level' => 'string',
            'api.logging.channel' => 'string',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'filesystems.links./workspace/public/storage' => 'string',
            ...
            'pagination.default_per_page' => 'string',
            'pagination.comments_per_page' => 'string',
            'pagination.news_per_page' => 'string',
            'pagination.video_posts_per_page' => 'string',
            ...
            'passport.tokens.access_token.expire' => 'string',
            'passport.tokens.refresh_token.expire' => 'string',
            'passport.tokens.personal_access_token.expire' => 'string',
            'passport.scopes.read-posts' => 'string',
            'passport.scopes.write-posts' => 'string',
            'passport.scopes.delete-posts' => 'string',
            'passport.scopes.read-comments' => 'string',
            'passport.scopes.write-comments' => 'string',
            'passport.scopes.delete-comments' => 'string',
            'passport.scopes.manage-users' => 'string',
            'passport.default_scopes' => 'array',
            'passport.token_types.Bearer' => 'string',
            'passport.token_types.Mac' => 'string',
            'passport.encrypt_tokens' => 'boolean',
            'passport.hash_client_secrets' => 'boolean',
            'passport.authorization_view' => 'string',
            'passport.unserializes_cookies' => 'boolean',
            'products.cache.enabled' => 'boolean',
            'products.cache.ttl' => 'integer',
            'products.cache.prefix' => 'string',
            'products.search.driver' => 'string',
            'products.search.min_length' => 'integer',
            'products.search.stop_words' => 'array',
            'products.pagination.default_per_page' => 'integer',
            'products.pagination.max_per_page' => 'integer',
            'products.pagination.available_per_page' => 'array',
            'products.sorting.default' => 'string',
            'products.sorting.available.price_asc.field' => 'string',
            'products.sorting.available.price_asc.direction' => 'string',
            'products.sorting.available.price_desc.field' => 'string',
            'products.sorting.available.price_desc.direction' => 'string',
            'products.sorting.available.rating_desc.field' => 'string',
            'products.sorting.available.rating_desc.direction' => 'string',
            'products.sorting.available.newest.field' => 'string',
            'products.sorting.available.newest.direction' => 'string',
            'products.validation.price.min' => 'integer',
            'products.validation.price.max' => 'double',
            'products.validation.rating.min' => 'integer',
            'products.validation.rating.max' => 'integer',
            'products.performance.slow_query_threshold' => 'integer',
            'products.performance.max_results' => 'integer',
            'products.performance.query_timeout' => 'integer',
            ...
            'route.api.version' => 'string',
            'route.api.prefix' => 'string',
            'route.api.middleware' => 'array',
            'route.api.rate_limit.enabled' => 'boolean',
            'route.api.rate_limit.max_attempts' => 'integer',
            'route.api.rate_limit.decay_minutes' => 'integer',
            'route.web.middleware' => 'array',
            'route.web.rate_limit.enabled' => 'boolean',
            'route.admin.prefix' => 'string',
            'route.admin.middleware' => 'array',
            'route.admin.name_prefix' => 'string',
            'route.caching.enabled' => 'boolean',
            'route.caching.duration' => 'integer',
            'route.bindings.product' => 'string',
            'route.bindings.category' => 'string',
            ...
            'services.passport.login_endpoint' => 'string',
            'services.passport.client_id' => 'NULL',
            'services.passport.client_secret' => 'NULL',
...
'view.paths','view.compiled','api.name','api.version','api.url',
'api.rate_limit.enabled','api.rate_limit.requests_per_minute','api.rate_limit.max_attempts','api.cors.allowed_origins','api.cors.allowed_methods',
'api.cors.allowed_headers','api.cors.exposed_headers','api.cors.max_age','api.cors.supports_credentials','api.pagination.default_per_page',
'api.pagination.max_per_page','api.cache.enabled','api.cache.ttl','api.security.force_https','api.security.hide_server_header',
'api.security.hide_powered_by_header','api.logging.enabled','api.logging.level','api.logging.channel','app.name',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./workspace/public/storage','logging.default','logging.deprecations.channel',
...
'pagination.default_per_page','pagination.comments_per_page','pagination.news_per_page','pagination.video_posts_per_page','passport.guard',
'passport.private_key','passport.public_key','passport.connection','passport.client_uuids','passport.personal_access_client.id',
'passport.personal_access_client.secret','passport.storage.database.connection','passport.tokens.access_token.expire','passport.tokens.refresh_token.expire','passport.tokens.personal_access_token.expire',
'passport.scopes.read-posts','passport.scopes.write-posts','passport.scopes.delete-posts','passport.scopes.read-comments','passport.scopes.write-comments',
'passport.scopes.delete-comments','passport.scopes.manage-users','passport.default_scopes','passport.token_types.Bearer','passport.token_types.Mac',
'passport.encrypt_tokens','passport.hash_client_secrets','passport.authorization_view','passport.unserializes_cookies','products.cache.enabled',
'products.cache.ttl','products.cache.prefix','products.search.driver','products.search.min_length','products.search.stop_words',
'products.pagination.default_per_page','products.pagination.max_per_page','products.pagination.available_per_page','products.sorting.default','products.sorting.available.price_asc.field',
'products.sorting.available.price_asc.direction','products.sorting.available.price_desc.field','products.sorting.available.price_desc.direction','products.sorting.available.rating_desc.field','products.sorting.available.rating_desc.direction',
'products.sorting.available.newest.field','products.sorting.available.newest.direction','products.validation.price.min','products.validation.price.max','products.validation.rating.min',
'products.validation.rating.max','products.performance.slow_query_threshold','products.performance.max_results','products.performance.query_timeout','queue.default',
...
'route.api.version','route.api.prefix','route.api.middleware','route.api.rate_limit.enabled','route.api.rate_limit.max_attempts',
'route.api.rate_limit.decay_minutes','route.web.middleware','route.web.rate_limit.enabled','route.admin.prefix','route.admin.middleware',
'route.admin.name_prefix','route.caching.enabled','route.caching.duration','route.bindings.product','route.bindings.category',
'services.postmark.token','services.resend.key','services.ses.key','services.ses.secret','services.ses.region',
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.passport.login_endpoint','services.passport.client_id','services.passport.client_secret',
...
'session.partitioned','sanctum.stateful','sanctum.guard','sanctum.expiration','sanctum.token_prefix',
...
'sanctum.csrf-cookie','products.index',
'home','products.index','storage.local',);
        registerArgumentsSet('views', 
'bookings.create','bookings.edit','bookings.index','bookings.show','guides.create',
'guides.index','guides.show','layouts.app','users.form','users.list',
...
'LOG_LEVEL','DB_CONNECTION','MYSQL_HOST','MYSQL_PORT','MYSQL_DBNAME',
'MYSQL_USER','MYSQL_PASSWORD','DB_HOST','DB_PORT','DB_DATABASE',
...
'CACHE_STORE','MEMCACHED_HOST','REDIS_CLIENT','MAIL_MAILER','MAIL_SCHEME',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','CACHE_DRIVER','REDIS_CLIENT','REDIS_HOST',
'REDIS_PORT','REDIS_PASSWORD','REDIS_DATABASE','DEFAULT_PER_PAGE','COMMENTS_PER_PAGE',
'NEWS_PER_PAGE','VIDEO_POSTS_PER_PAGE','PASSPORT_PASSWORD_GRANT_CLIENT_ID','PASSPORT_PASSWORD_GRANT_CLIENT_SECRET','PASSPORT_ACCESS_TOKEN_EXPIRE',
'PASSPORT_REFRESH_TOKEN_EXPIRE','PASSPORT_PERSONAL_ACCESS_TOKEN_EXPIRE','PASSPORT_HASH_CLIENT_SECRETS','PASSPORT_ENCRYPT_TOKENS','API_NAME',
'API_VERSION','API_URL','API_RATE_LIMIT_ENABLED','API_RATE_LIMIT_REQUESTS_PER_MINUTE','API_RATE_LIMIT_MAX_ATTEMPTS',
'API_CORS_ALLOWED_ORIGINS','API_CORS_ALLOWED_METHODS','API_CORS_ALLOWED_HEADERS','API_CORS_EXPOSED_HEADERS','API_CORS_MAX_AGE',
'API_CORS_SUPPORTS_CREDENTIALS','API_DEFAULT_PER_PAGE','API_MAX_PER_PAGE','API_CACHE_ENABLED','API_CACHE_TTL',
'API_FORCE_HTTPS','API_HIDE_SERVER_HEADER','API_HIDE_POWERED_BY_HEADER','API_LOGGING_ENABLED','API_LOGGING_LEVEL',
'API_LOGGING_CHANNEL',);
